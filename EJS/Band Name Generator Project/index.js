...
app.post("/submit", (req, res) => {
  ...
  const adjInd = Math.floor(Math.random() * adj.length);
  const nounInd = Math.floor(Math.random() * noun.length);

  const bandName = adj[adjInd] + " " + noun[nounInd];
  res.render("index.ejs", { currYear, bandName });
});
